...
public class ${className}Controller {
    ...
    @PreAuthorize("@el.check('${changeClassName?lower_case}:list')")
    ...
    @PreAuthorize("@el.check('${changeClassName?lower_case}:add')")
    ...
    @PreAuthorize("@el.check('${changeClassName?lower_case}:edit')")
    ...
    @PreAuthorize("@el.check('${changeClassName?lower_case}:del')")
    @DeleteMapping
